...
3. Review every hunk, in priority order:
   ...
   - missing symmetry the rules imply (edited vendored code without regenerating patches; new module without its committed smoke; a "why" comment that belongs in the living docs),
